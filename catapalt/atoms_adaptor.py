...
class OCPAseAtomsAdaptor(AseAtomsAdaptor):
    """
    ...
    def get_atoms(structure, **kwargs):
        ...
        charges = (
            structure.site_properties["final_charge"]
        ...
        if magmoms or charges:
            if magmoms and charges:
                calc = SinglePointDFTCalculator(
                    atoms, **{"magmoms": magmoms, "charges": charges}
                )
            elif magmoms:
    ...
    def get_structure(atoms, cls=None, **cls_kwargs):
        ...
        if cls == Molecule:
            ...
            structure = cls(
                lattice, symbols, positions, coords_are_cartesian=True, **cls_kwargs
            )
